# Amazona Sample ECommerce Website

![amazona-sample](/template/images/amazona-sample.png)

# React & Node Tutorial Amazona Sample Website

Welcome to my React and Node Amazona Sample Website. This website creates for learning purposes. This Website a fully-functional e-commerce website exactly like amazon. I using MERN stack (MongoDB, ExpressJS, React, and Node.JS). Here admin able to create products, update products, and handle orders.
